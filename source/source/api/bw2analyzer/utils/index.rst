...
.. py:function:: print_recursive_calculation(activity, lcia_method, amount=1, max_level=3, cutoff=0.01, string_length=130, file_obj=None, tab_character='  ', use_matrix_values=False, _lca_obj=None, _total_score=None, __level=0, __first=True)
   ...
   :param string_length: int. Maximum length of printed string.
...
.. py:function:: print_recursive_supply_chain(activity, amount=1, max_level=2, cutoff=0, string_length=130, file_obj=None, tab_character='  ', __level=0)
   ...
   :param string_length: int. Maximum length of each line.
   :param file_obj: File-like object (supports ``.write``), optional. Output will be written to this object if provided.
   :param tab_character: str. Character to use to indicate indentation.
