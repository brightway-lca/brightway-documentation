...
.. py:class:: CSVImporter(filepath)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.CSVImporter
      :parts: 1
      :private-bases:
...
.. py:class:: CSVLCIAImporter(filepath, name, description, unit, **metadata)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.CSVLCIAImporter
      :parts: 1
      :private-bases:
...
.. py:class:: EcoinventLCIAImporter
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.EcoinventLCIAImporter
      :parts: 1
      :private-bases:
...
.. py:class:: Ecospold1LCIAImporter(filepath, biosphere=None)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.Ecospold1LCIAImporter
      :parts: 1
      :private-bases:
...
.. py:class:: Ecospold2BiosphereImporter(name='biosphere3', version='3.9')
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.Ecospold2BiosphereImporter
      :parts: 1
      :private-bases:
...
.. py:class:: ExcelImporter(filepath)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.ExcelImporter
      :parts: 1
      :private-bases:
...
.. py:class:: ExcelLCIAImporter(filepath, name, description, unit, **metadata)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.ExcelLCIAImporter
      :parts: 1
      :private-bases:
...
.. py:class:: MultiOutputEcospold1Importer(*args, **kwargs)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.MultiOutputEcospold1Importer
      :parts: 1
      :private-bases:
...
.. py:class:: NoIntegerCodesEcospold1Importer(*args, **kwargs)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.NoIntegerCodesEcospold1Importer
      :parts: 1
      :private-bases:
...
.. py:class:: SimaProCSVImporter(filepath, name=None, delimiter=';', encoding='latin-1', normalize_biosphere=True, biosphere_db=None)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.SimaProCSVImporter
      :parts: 1
      :private-bases:
...
.. py:class:: SimaProLCIACSVImporter(filepath, biosphere=None, delimiter=';', encoding='latin-1', normalize_biosphere=True)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.SimaProLCIACSVImporter
      :parts: 1
      :private-bases:
...
.. py:class:: SingleOutputEcospold1Importer(filepath, db_name, use_mp=True, extractor=Ecospold1DataExtractor)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.SingleOutputEcospold1Importer
      :parts: 1
      :private-bases:
...
.. py:class:: SingleOutputEcospold2Importer(dirpath, db_name, extractor=Ecospold2DataExtractor, use_mp=True, signal=None)
   ...
   .. autoapi-inheritance-diagram:: bw2io.importers.SingleOutputEcospold2Importer
      :parts: 1
      :private-bases:
