:py:mod:`bw2calc.log_utils`
===========================

.. py:module:: bw2calc.log_utils
...
.. autoapisummary::
   ...
   bw2calc.log_utils.JSONFormatter
...
.. autoapisummary::
   ...
   bw2calc.log_utils.create_logger
...
.. autoapisummary::
   ...
   bw2calc.log_utils.BUILTIN_ATTRS
...
.. py:class:: JSONFormatter(fmt=None, datefmt=None, style='%', validate=True, *, defaults=None)
   ...
   .. autoapi-inheritance-diagram:: bw2calc.log_utils.JSONFormatter
      :parts: 1
      :private-bases:
   ...
   .. py:attribute:: json_lib

      

   .. py:method:: extra_from_record(record)
   ...
   .. py:method:: json_record(message, extra, record)


   .. py:method:: to_json(record)



.. py:function:: create_logger(dirpath=None, name=None, **kwargs)
